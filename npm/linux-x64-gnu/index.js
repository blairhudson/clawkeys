...
const candidates = ["clawkeys.linux-x64-gnu.node", "clawkeys-linux-x64-gnu.node", "clawkeys.linux-x64-gnu.node.napi.node"];
...
if (!bindingFile) {
  throw new Error("Native addon binary missing for clawkeys-linux-x64-gnu");
}
