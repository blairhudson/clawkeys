...
const candidates = ["clawkeys.darwin-arm64.node", "clawkeys-darwin-arm64.node", "clawkeys.darwin-arm64.node.napi.node"];
...
if (!bindingFile) {
  throw new Error("Native addon binary missing for clawkeys-darwin-arm64");
}
