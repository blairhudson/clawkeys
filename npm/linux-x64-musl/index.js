...
const candidates = ["clawkeys.linux-x64-musl.node", "clawkeys-linux-x64-musl.node", "clawkeys.linux-x64-musl.node.napi.node"];
...
if (!bindingFile) {
  throw new Error("Native addon binary missing for clawkeys-linux-x64-musl");
}
